...
<div class="flex flex-col items-center relative font-rubik text-surface-900 w-full mx-auto mt-10">
  ...
  <div class='xs:w-full md:w-8/12 z-1 px-4'>
    <article class="mx-auto text-surface-900 prose lg:prose-xl text-justify">
      <h1 class="font-montserrat font-bold xs:text-4xl md:text-6xl text-surface-900 xs:w-full capitalize">{post.title}</h1>
      {@html post.html}
    </article>
    <div class="my-6 text-surface-900" id="disqus_thread"></div>      
